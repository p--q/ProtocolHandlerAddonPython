...
class Images(MenuItem):
    ...
    def __init__(self,dic):
        ...
        name = "com.sun.star.comp.framework.addon.image1"
        url = dic["HANDLED_PROTOCOL"] + ":Function1"
        dic_image = {
        ...
        name = "com.sun.star.comp.framework.addon.image2"
        url = "org.openoffice.Office.addon.example:Help"
        dic_image = {
